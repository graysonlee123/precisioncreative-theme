...
$nav_breakpoint = 'navbar-expand-' . get_theme_mod('desktop_nav_collapse', 'lg');
...
<body <?php body_class(); ?>>
  ...
  <nav class="navbar <?php echo $nav_breakpoint; ?>">
    <div class="navbar__container container">
      ...
      <span id="hamburger" class="<?php echo $hamburger_class; ?>">
    ...
    <?php if ($mobile_menu_type === 'accordion') : ?>
      <!-- Accordion -->
      <div id="accordion" class="container accordion--closed">
        <?php
        wp_nav_menu(
          array(
            'theme_location'  => 'mobile_menu',
            'container_id'    => 'accordionLinks__container',
            'container_class' => 'accordionLinks__container',
            'menu_id'         => 'accordionLinks__menu',
            'menu_class'      => 'accordionLinks__menu',
            'fallback_cb'     => 'fallback_menu',
            'depth'           => 1,
            'walker'          => new Understrap_WP_Bootstrap_Navwalker(),
          )
